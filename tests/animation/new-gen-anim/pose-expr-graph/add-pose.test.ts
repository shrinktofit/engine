import { AddPose } from "../../../../cocos/animation/marionette/pose-graph/pose-nodes/add-pose";
...
test(`Additivity inheritance`, () => {
    ...
    function t(initialAdditive: boolean) {
        ...
        addPose.base = new base_AdditivityCheckMock.PoseNodeMock();
        addPose.addition = new addition_AdditivityCheckMock.PoseNodeMock();
