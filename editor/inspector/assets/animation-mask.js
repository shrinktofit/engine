...
exports.methods = {
    ...
    async apply() {
        this.reset();
        await Editor.Message.request('scene', 'apply-animation-mask', this.asset.uuid, this.physicsMaterial);
    },
    reset() {
    ...
    async dataChange() {
        await Editor.Message.request('scene', 'change-animation-mask', this.physicsMaterial);
        this.setDirtyData();
