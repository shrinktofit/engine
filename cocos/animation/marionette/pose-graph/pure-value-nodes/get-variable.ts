...
@ccclass(`${CLASS_NAME_PREFIX_PV_NODES}PVNodeGetVariable`)
@poseGraphCreateNodeFactory(createNodeFactory)
export abstract class PVNodeGetVariable<T> extends SingleOutputPVNode<T> {
    @editable
    @serializable
    public variableName = '';
...
if (EDITOR) {
    PVNodeGetVariable.prototype.getTitle = function getTitle (this: PVNodeGetVariable<any>) {
...
export class PVNodeGetVariableFloat extends PVNodeGetVariable<number> {
    constructor () {
...
export class PVNodeGetVariableInteger extends PVNodeGetVariable<number> {
    constructor () {
...
export class PVNodeGetVariableBoolean extends PVNodeGetVariable<boolean> {
    constructor () {
...
export class PVNodeGetVariableVec3 extends PVNodeGetVariable<Readonly<Vec3>> {
    constructor () {
...
export class PVNodeGetVariableQuat extends PVNodeGetVariable<Quat> {
    constructor () {
