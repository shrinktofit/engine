...
export class CopyTransform extends SinglePoseModifier {
    ...
    public bind (context: AnimationGraphBindingContext): void {
        super.bind(context);
        const sourceTransformHandle = context.bindTransformByName(this.sourceTransformName);
        const targetTransformHandle = context.bindTransformByName(this.targetTransformName);
