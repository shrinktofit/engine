            ...
            if (parentBoneName && ikRootBoneName) {
                ...
                if (!hEndEffector || !hMiddle || !hIKRoot) {
                    ...
                    const hEndEffectorTarget = this.endEffectorTargetBoneName
                        ? context.outerContext.bindTransformByName(this.endEffectorTargetBoneName) ?? undefined
                        : undefined;
                    const hMiddleTarget = this.middleBoneTargetBoneName
                        ? context.outerContext.bindTransformByName(this.middleBoneTargetBoneName) ?? undefined
                        : undefined;
