import { ConditionEvalContext, TransitionBindingContext } from '../condition-base';
...
export abstract class TCBinding<TValueType extends TCBindingValueType> {
    ...
    public abstract bind(
        ...
        transitionBindingContext: TransitionBindingContext,
    ): TCBindingEvaluation<TValueType> | undefined;
}
