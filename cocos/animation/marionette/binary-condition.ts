import {
    ...
    validateVariableTypeNumeric,
    EvaluationTimeAuxiliaryCurveVisitor,
} from './parametric';
import { assertIsTrue, error, _decorator } from '../../core';
...
import { Condition, ConditionEval } from './condition';
...
abstract class FloatValueNode {
    public abstract bind(context: BindContext, transitionContext: TransitionBindingContext): FloatValueEvaluation | undefined;
}
...
export class BinaryCondition implements Condition {
    ...
    public [createEval] (context: BindContext, transitionBindingContext: TransitionBindingContext) {
        const {
            operator,
            lhs,
            rhs,
